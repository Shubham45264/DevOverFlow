...
const Page = async ({
  ...
  /* ---------------- DEBUG LOGS ---------------- */
  console.log("PROFILE USER ID:", params.userId);
  console.log("USER PREFS:", user.prefs);
  console.log("RAW REPUTATION:", user.prefs?.reputation);
  ...
  console.log("PARSED REPUTATION:", reputation);
    ...
    <MagicContainer className="flex h-[500px] w-full flex-col gap-4 lg:h-[250px] lg:flex-row">
      ...
      <MagicCard className="flex w-full cursor-pointer flex-col items-center justify-center overflow-hidden p-20 shadow-2xl">
        ...
        <p className="z-10 whitespace-nowrap text-4xl font-medium text-gray-800 dark:text-gray-200">
          ...
          <NumberTicker value={Number.isNaN(reputation) ? 0 : reputation} />
        </p>
